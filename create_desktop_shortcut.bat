...
echo 🎸 Creating ShamaOllama Desktop Shortcuts...
echo.
...
echo 2. Silent launch - Batch file (minimal compatibility issues)
...
if "%choice%"=="1" (
    ...
    echo ✅ Regular desktop shortcut created successfully!
    echo 📍 Shortcut: ShamaOllama.lnk
) else if "%choice%"=="2" (
    ...
    echo ✅ Silent batch desktop shortcut created successfully!
    echo 📍 Shortcut: ShamaOllama.lnk
    echo ℹ️  This shortcut uses the silent batch launcher for maximum compatibility.
) else if "%choice%"=="3" (
    ...
    echo ✅ Silent PowerShell desktop shortcut created successfully!
    echo 📍 Shortcut: ShamaOllama (PowerShell).lnk
) else if "%choice%"=="4" (
    ...
    echo ✅ Silent VBScript desktop shortcut created successfully!
    echo 📍 Shortcut: ShamaOllama (VBScript).lnk
) else (
